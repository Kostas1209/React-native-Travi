...
import { View, Text, TextInput, KeyboardAvoidingView, Animated} from "react-native";
...
{
    isPreviousTravel = new Date() > this.props.route.params.travelling.comeDate;
    ...
    render()
    {
        return(
            ...
            >
                ...
                <TouchableOpacity
                    disabled={this.isPreviousTravel}
                ...
                <TextInput 
                    editable={!this.isPreviousTravel}
                    multiline={true}
                ...
                <View style={{marginTop:50, marginBottom:50  ,flexDirection: "row", alignSelf: "center"}}>
                    <PaperButton
                            mode="contained"
                            icon="delete"
                            style={{width: "35%", alignSelf: "center", marginRight: 20}}
                            color={Colors.red500}
                            onPress={()=>{
